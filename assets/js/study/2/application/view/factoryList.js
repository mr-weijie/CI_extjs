 ...
 */
Ext.define('AM.view.factoryList',{
    extend:'Ext.grid.Panel',//定义一个grid.Panel面板
    alias:'widget.factoryList',//定义一个alias,给app.js直接调用，这样就不必使用Ext.create('AM.views.list',{}):了，而是直接使用xtype:userlist即可。
    title:'MVC-Demo',
    ...
    dockedItems:[//加上停靠栏
        {
            ...
            store:'AM.store.factoryStore',//就是前面定义的users类,//这个store和grid中的store一致
            dock:'bottom',//停靠位置
 ...
 // columnLines:true,//显示竖线
    store:'AM.store.factoryStore',//就是前面定义的Users类
